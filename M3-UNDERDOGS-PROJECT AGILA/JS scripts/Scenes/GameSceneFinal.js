...
class GameSceneFinal extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image("foods", "Assets/Images/Others/Meat.png");
        this.load.image("plat1", "Assets/Images/Others/PlatformL3.png");
        this.load.image("platT2", "Assets/Images/Others/PlatformT2.png");
        this.load.image("platT1", "Assets/Images/Others/PlatformT1.png");
    ...
    create() {
        ...
        this.physics.add.collider(player3, grass, lose, null, this);
